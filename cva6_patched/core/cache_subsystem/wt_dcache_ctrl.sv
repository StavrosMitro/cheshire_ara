...
#(
    ...
    // Task J2/F3 debug only: gives this instance the full probe set when
    // true (intended for the load-unit port, k==1 -- see wt_dcache.sv:191),
    // vs. just a state_q tap otherwise (cheap cross-port race visibility).
    // No functional effect.
    parameter bit IsLoadPort = 1'b0
) (
